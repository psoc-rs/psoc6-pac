#[doc = "Reader of register WR_CMD_CTL"]
pub type R = crate::R<u32, super::WR_CMD_CTL>;
#[doc = "Writer for register WR_CMD_CTL"]
pub type W = crate::W<u32, super::WR_CMD_CTL>;
#[doc = "Register WR_CMD_CTL `reset()`'s with value 0"]
impl crate::ResetValue for super::WR_CMD_CTL {
    type Type = u32;
    #[inline(always)]
