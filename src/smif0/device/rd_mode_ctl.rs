#[doc = "Reader of register RD_MODE_CTL"]
pub type R = crate::R<u32, super::RD_MODE_CTL>;
#[doc = "Writer for register RD_MODE_CTL"]
pub type W = crate::W<u32, super::RD_MODE_CTL>;
#[doc = "Register RD_MODE_CTL `reset()`'s with value 0"]
impl crate::ResetValue for super::RD_MODE_CTL {
    type Type = u32;
    #[inline(always)]
