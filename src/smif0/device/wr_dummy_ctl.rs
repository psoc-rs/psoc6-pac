#[doc = "Reader of register WR_DUMMY_CTL"]
pub type R = crate::R<u32, super::WR_DUMMY_CTL>;
#[doc = "Writer for register WR_DUMMY_CTL"]
pub type W = crate::W<u32, super::WR_DUMMY_CTL>;
#[doc = "Register WR_DUMMY_CTL `reset()`'s with value 0"]
impl crate::ResetValue for super::WR_DUMMY_CTL {
    type Type = u32;
    #[inline(always)]
