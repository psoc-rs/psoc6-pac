#[doc = "Reader of register WR_MODE_CTL"]
pub type R = crate::R<u32, super::WR_MODE_CTL>;
#[doc = "Writer for register WR_MODE_CTL"]
pub type W = crate::W<u32, super::WR_MODE_CTL>;
#[doc = "Register WR_MODE_CTL `reset()`'s with value 0"]
impl crate::ResetValue for super::WR_MODE_CTL {
    type Type = u32;
    #[inline(always)]
