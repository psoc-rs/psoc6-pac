#[doc = "Reader of register PEER_ADDR_H"]
pub type R = crate::R<u32, super::PEER_ADDR_H>;
#[doc = "Writer for register PEER_ADDR_H"]
pub type W = crate::W<u32, super::PEER_ADDR_H>;
#[doc = "Register PEER_ADDR_H `reset()`'s with value 0"]
impl crate::ResetValue for super::PEER_ADDR_H {
    type Type = u32;
    #[inline(always)]
