...
pub type PEER_SEC_ADDR_L_R = crate::FieldReader<u16, u16>;
#[doc = "Field `PEER_SEC_ADDR_L` writer - Lower 16 bit of 48-bit secondary address of the peer device for ADV_DIR."]
pub type PEER_SEC_ADDR_L_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PEER_SEC_ADDR_ADV_L_SPEC, u16, u16, 16, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:15 - Lower 16 bit of 48-bit secondary address of the peer device for ADV_DIR."]
    #[inline(always)]
    pub fn peer_sec_addr_l(&mut self) -> PEER_SEC_ADDR_L_W<0> {
        PEER_SEC_ADDR_L_W::new(self)
    }
