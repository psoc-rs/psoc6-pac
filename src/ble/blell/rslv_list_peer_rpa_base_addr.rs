...
pub type RSLV_LIST_PEER_RPA_BASE_ADDR_R = crate::FieldReader<u16, u16>;
...
pub type RSLV_LIST_PEER_RPA_BASE_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RSLV_LIST_PEER_RPA_BASE_ADDR_SPEC, u16, u16, 16, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:15 - Device address values written to the list are written as 16-bit wide address."]
    #[inline(always)]
    pub fn rslv_list_peer_rpa_base_addr(&mut self) -> RSLV_LIST_PEER_RPA_BASE_ADDR_W<0> {
        RSLV_LIST_PEER_RPA_BASE_ADDR_W::new(self)
    }
