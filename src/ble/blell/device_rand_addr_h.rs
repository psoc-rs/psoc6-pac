...
pub type DEVICE_RAND_ADDR_H_R = crate::FieldReader<u16, u16>;
#[doc = "Field `DEVICE_RAND_ADDR_H` writer - Higher 16 bit of 48-bit random address of the device."]
pub type DEVICE_RAND_ADDR_H_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DEVICE_RAND_ADDR_H_SPEC, u16, u16, 16, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:15 - Higher 16 bit of 48-bit random address of the device."]
    #[inline(always)]
    pub fn device_rand_addr_h(&mut self) -> DEVICE_RAND_ADDR_H_W<0> {
        DEVICE_RAND_ADDR_H_W::new(self)
    }
