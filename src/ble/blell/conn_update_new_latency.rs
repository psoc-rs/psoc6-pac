...
pub type CONN_UPDT_SLV_LATENCY_R = crate::FieldReader<u16, u16>;
...
pub type CONN_UPDT_SLV_LATENCY_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CONN_UPDATE_NEW_LATENCY_SPEC, u16, u16, 16, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:15 - This register will have the new slave latency parameter that the hardware will use after the connection update instant. Before the instant, the connection interval in the register SLAVE_LATENCY will be used by hardware."]
    #[inline(always)]
    pub fn conn_updt_slv_latency(&mut self) -> CONN_UPDT_SLV_LATENCY_W<0> {
        CONN_UPDT_SLV_LATENCY_W::new(self)
    }
