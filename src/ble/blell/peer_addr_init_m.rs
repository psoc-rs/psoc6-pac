#[doc = "Reader of register PEER_ADDR_INIT_M"]
pub type R = crate::R<u32, super::PEER_ADDR_INIT_M>;
#[doc = "Writer for register PEER_ADDR_INIT_M"]
pub type W = crate::W<u32, super::PEER_ADDR_INIT_M>;
#[doc = "Register PEER_ADDR_INIT_M `reset()`'s with value 0"]
impl crate::ResetValue for super::PEER_ADDR_INIT_M {
    type Type = u32;
    #[inline(always)]
