...
pub type PDU_ACCESS_ADDRESS_LOWER_BITS_R = crate::FieldReader<u16, u16>;
...
pub type PDU_ACCESS_ADDRESS_LOWER_BITS_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PDU_ACCESS_ADDR_L_REGISTER_SPEC, u16, u16, 16, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:15 - This field defines the lower 16 bits of the access address for each Link layer connection between any two devices."]
    #[inline(always)]
    pub fn pdu_access_address_lower_bits(&mut self) -> PDU_ACCESS_ADDRESS_LOWER_BITS_W<0> {
        PDU_ACCESS_ADDRESS_LOWER_BITS_W::new(self)
    }
