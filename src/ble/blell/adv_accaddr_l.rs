...
pub type ADV_ACCADDR_L_R = crate::FieldReader<u16, u16>;
#[doc = "Field `ADV_ACCADDR_L` writer - Lower 16 bit of ADV packet access code"]
pub type ADV_ACCADDR_L_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ADV_ACCADDR_L_SPEC, u16, u16, 16, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:15 - Lower 16 bit of ADV packet access code"]
    #[inline(always)]
    pub fn adv_accaddr_l(&mut self) -> ADV_ACCADDR_L_W<0> {
        ADV_ACCADDR_L_W::new(self)
    }
