...
pub type CONN_1_PARAM_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CONN_1_PARAM` writer - N/A"]
pub type CONN_1_PARAM_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CONN_1_PARAM_MEM_BASE_ADDR_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - N/A"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:15 - N/A"]
    #[inline(always)]
    pub fn conn_1_param(&mut self) -> CONN_1_PARAM_W<0> {
        CONN_1_PARAM_W::new(self)
    }
