...
pub type DATA_CHANNELS_L1_R = crate::FieldReader<u16, u16>;
...
pub type DATA_CHANNELS_L1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DATA_CHANNELS_L1_SPEC, u16, u16, 16, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:15 - This register field indicates which of the data channels are in use. This stores the information for the lower 16 (15:0) data channel indices. '1' indicates the corresponding data channel is used and '0' indicates the channel is unused."]
    #[inline(always)]
    pub fn data_channels_l1(&mut self) -> DATA_CHANNELS_L1_W<0> {
        DATA_CHANNELS_L1_W::new(self)
    }
