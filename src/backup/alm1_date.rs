...
pub type ALM_DATE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ALM1_DATE_SPEC, u8, u8, 6, O>;
...
pub type ALM_MON_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ALM1_DATE_SPEC, u8, u8, 5, O>;
