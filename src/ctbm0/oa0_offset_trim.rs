...
pub type OA0_OFFSET_TRIM_R = crate::FieldReader<u8, u8>;
#[doc = "Field `OA0_OFFSET_TRIM` writer - Opamp0 offset trim"]
pub type OA0_OFFSET_TRIM_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OA0_OFFSET_TRIM_SPEC, u8, u8, 6, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:5 - Opamp0 offset trim"]
    #[inline(always)]
    pub fn oa0_offset_trim(&mut self) -> OA0_OFFSET_TRIM_W<0> {
        OA0_OFFSET_TRIM_W::new(self)
    }
