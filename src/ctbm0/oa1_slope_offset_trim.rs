...
impl crate::ResetValue for super::OA1_SLOPE_OFFSET_TRIM {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `OA1_SLOPE_OFFSET_TRIM`"]
pub type OA1_SLOPE_OFFSET_TRIM_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `OA1_SLOPE_OFFSET_TRIM`"]
