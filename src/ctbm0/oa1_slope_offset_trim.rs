...
pub type OA1_SLOPE_OFFSET_TRIM_R = crate::FieldReader<u8, u8>;
#[doc = "Field `OA1_SLOPE_OFFSET_TRIM` writer - Opamp1 slope offset drift trim"]
pub type OA1_SLOPE_OFFSET_TRIM_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, OA1_SLOPE_OFFSET_TRIM_SPEC, u8, u8, 6, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:5 - Opamp1 slope offset drift trim"]
    #[inline(always)]
    pub fn oa1_slope_offset_trim(&mut self) -> OA1_SLOPE_OFFSET_TRIM_W<0> {
        OA1_SLOPE_OFFSET_TRIM_W::new(self)
    }
