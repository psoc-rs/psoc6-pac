#[doc = "Reader of register SRSS_INTR"]
pub type R = crate::R<u32, super::SRSS_INTR>;
#[doc = "Writer for register SRSS_INTR"]
pub type W = crate::W<u32, super::SRSS_INTR>;
#[doc = "Register SRSS_INTR `reset()`'s with value 0"]
impl crate::ResetValue for super::SRSS_INTR {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 5 - Clock calibration counter is done"]
    #[inline(always)]
