...
pub type MCWDT_INT0_W<'a, const O: u8> = crate::BitWriter<'a, u32, MCWDT_INTR_SPEC, bool, O>;
...
pub type MCWDT_INT1_W<'a, const O: u8> = crate::BitWriter<'a, u32, MCWDT_INTR_SPEC, bool, O>;
...
pub type MCWDT_INT2_W<'a, const O: u8> = crate::BitWriter<'a, u32, MCWDT_INTR_SPEC, bool, O>;
impl R {
