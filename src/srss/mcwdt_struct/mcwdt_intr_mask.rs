#[doc = "Reader of register MCWDT_INTR_MASK"]
pub type R = crate::R<u32, super::MCWDT_INTR_MASK>;
#[doc = "Writer for register MCWDT_INTR_MASK"]
pub type W = crate::W<u32, super::MCWDT_INTR_MASK>;
#[doc = "Register MCWDT_INTR_MASK `reset()`'s with value 0"]
impl crate::ResetValue for super::MCWDT_INTR_MASK {
    type Type = u32;
    #[inline(always)]
