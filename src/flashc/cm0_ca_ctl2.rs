#[doc = "Reader of register CM0_CA_CTL2"]
pub type R = crate::R<u32, super::CM0_CA_CTL2>;
#[doc = "Writer for register CM0_CA_CTL2"]
pub type W = crate::W<u32, super::CM0_CA_CTL2>;
#[doc = "Register CM0_CA_CTL2 `reset()`'s with value 0x012c"]
impl crate::ResetValue for super::CM0_CA_CTL2 {
    type Type = u32;
    #[inline(always)]
