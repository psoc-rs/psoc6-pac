#[doc = "Reader of register CAL_CTL1"]
pub type R = crate::R<u32, super::CAL_CTL1>;
#[doc = "Writer for register CAL_CTL1"]
pub type W = crate::W<u32, super::CAL_CTL1>;
#[doc = "Register CAL_CTL1 `reset()`'s with value 0x0008_8f8f"]
impl crate::ResetValue for super::CAL_CTL1 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `VCT_TRIM_HI_HV`"]
pub type VCT_TRIM_HI_HV_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `VCT_TRIM_HI_HV`"]
...
#[doc = "Reader of field `CDAC_HI_HV`"]
pub type CDAC_HI_HV_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `CDAC_HI_HV`"]
...
#[doc = "Reader of field `VBG_TRIM_HI_HV`"]
pub type VBG_TRIM_HI_HV_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `VBG_TRIM_HI_HV`"]
...
#[doc = "Reader of field `VBG_TC_TRIM_HI_HV`"]
pub type VBG_TC_TRIM_HI_HV_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `VBG_TC_TRIM_HI_HV`"]
