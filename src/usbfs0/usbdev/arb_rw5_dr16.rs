#[doc = "Reader of register ARB_RW5_DR16"]
pub type R = crate::R<u32, super::ARB_RW5_DR16>;
#[doc = "Writer for register ARB_RW5_DR16"]
pub type W = crate::W<u32, super::ARB_RW5_DR16>;
#[doc = "Register ARB_RW5_DR16 `reset()`'s with value 0"]
impl crate::ResetValue for super::ARB_RW5_DR16 {
    type Type = u32;
    #[inline(always)]
