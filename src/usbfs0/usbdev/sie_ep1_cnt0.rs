...
pub type DATA_COUNT_MSB_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SIE_EP1_CNT0_SPEC, u8, u8, 3, O>;
...
pub type DATA_VALID_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SIE_EP1_CNT0_SPEC, DATA_VALID_A, O>;
...
pub type DATA_TOGGLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, SIE_EP1_CNT0_SPEC, bool, O>;
impl R {
