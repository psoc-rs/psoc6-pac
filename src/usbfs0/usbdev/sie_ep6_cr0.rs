...
pub type MODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SIE_EP6_CR0_SPEC, u8, MODE_A, 4, O>;
...
pub type ACKED_TXN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SIE_EP6_CR0_SPEC, ACKED_TXN_A, O>;
...
pub type NAK_INT_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SIE_EP6_CR0_SPEC, bool, O>;
...
pub type ERR_IN_TXN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SIE_EP6_CR0_SPEC, bool, O>;
...
pub type STALL_W<'a, const O: u8> = crate::BitWriter<'a, u32, SIE_EP6_CR0_SPEC, bool, O>;
impl R {
