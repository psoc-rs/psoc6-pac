#[doc = "Reader of register SIE_EP7_CNT1"]
pub type R = crate::R<u32, super::SIE_EP7_CNT1>;
#[doc = "Writer for register SIE_EP7_CNT1"]
pub type W = crate::W<u32, super::SIE_EP7_CNT1>;
#[doc = "Register SIE_EP7_CNT1 `reset()`'s with value 0"]
impl crate::ResetValue for super::SIE_EP7_CNT1 {
    type Type = u32;
    #[inline(always)]
