...
pub type IN_DATA_RDY_W<'a, const O: u8> = crate::BitWriter<'a, u32, ARB_EP3_CFG_SPEC, bool, O>;
...
pub type DMA_REQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, ARB_EP3_CFG_SPEC, bool, O>;
...
pub type CRC_BYPASS_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, ARB_EP3_CFG_SPEC, CRC_BYPASS_A, O>;
...
pub type RESET_PTR_W<'a, const O: u8> = crate::BitWriter<'a, u32, ARB_EP3_CFG_SPEC, RESET_PTR_A, O>;
