...
#[doc = "Field `BLK_NUM` reader - Set the total byte number for DMA transfer. If HOST_EP1_RW1_DR or HOST_EP1_RW2_DR is written, the block number counter is decrement when DMAE='1'. - Set this bits before DMA transfer is enabled (HOST_DMA_ENBL.DM_DP1DRQE='1')"]
pub type BLK_NUM_R = crate::FieldReader<u16, u16>;
#[doc = "Field `BLK_NUM` writer - Set the total byte number for DMA transfer. If HOST_EP1_RW1_DR or HOST_EP1_RW2_DR is written, the block number counter is decrement when DMAE='1'. - Set this bits before DMA transfer is enabled (HOST_DMA_ENBL.DM_DP1DRQE='1')"]
pub type BLK_NUM_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, HOST_EP1_BLK_SPEC, u16, u16, 16, O>;
impl R {
