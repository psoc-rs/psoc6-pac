...
#[doc = "Field `BFDT16` reader - Data Register for EP1. The 2-Byte data is valid."]
pub type BFDT16_R = crate::FieldReader<u16, u16>;
#[doc = "Field `BFDT16` writer - Data Register for EP1. The 2-Byte data is valid."]
pub type BFDT16_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, HOST_EP1_RW2_DR_SPEC, u16, u16, 16, O>;
impl R {
