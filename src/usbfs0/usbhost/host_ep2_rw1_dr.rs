...
#[doc = "Field `BFDT8` reader - Data Register for EP2. The 1-Byte data is valid."]
pub type BFDT8_R = crate::FieldReader<u8, u8>;
#[doc = "Field `BFDT8` writer - Data Register for EP2. The 1-Byte data is valid."]
pub type BFDT8_W<'a, const O: u8> = crate::FieldWriter<'a, u32, HOST_EP2_RW1_DR_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - Data Register for EP2. The 1-Byte data is valid."]
    #[inline(always)]
