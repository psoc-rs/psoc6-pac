#[doc = "Reader of register CTDAC_SW"]
pub type R = crate::R<u32, super::CTDAC_SW>;
#[doc = "Writer for register CTDAC_SW"]
pub type W = crate::W<u32, super::CTDAC_SW>;
#[doc = "Register CTDAC_SW `reset()`'s with value 0"]
impl crate::ResetValue for super::CTDAC_SW {
    type Type = u32;
    #[inline(always)]
