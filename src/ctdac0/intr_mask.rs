...
pub type VDAC_EMPTY_MASK_R = crate::BitReader<bool>;
#[doc = "Field `VDAC_EMPTY_MASK` writer - Mask bit for corresponding bit in interrupt request register."]
pub type VDAC_EMPTY_MASK_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - Mask bit for corresponding bit in interrupt request register."]
    #[inline(always)]
    pub fn vdac_empty_mask(&self) -> VDAC_EMPTY_MASK_R {
        VDAC_EMPTY_MASK_R::new((self.bits & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Mask bit for corresponding bit in interrupt request register."]
    #[inline(always)]
    pub fn vdac_empty_mask(&mut self) -> VDAC_EMPTY_MASK_W<0> {
        VDAC_EMPTY_MASK_W::new(self)
    }
