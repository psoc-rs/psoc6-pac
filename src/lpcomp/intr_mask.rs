...
pub type COMP0_MASK_R = crate::BitReader<bool>;
#[doc = "Field `COMP0_MASK` writer - Mask bit for corresponding bit in interrupt request register."]
pub type COMP0_MASK_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, O>;
...
pub type COMP1_MASK_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, O>;
impl R {
