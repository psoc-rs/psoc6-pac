#[doc = "Reader of register RAM1_CTL0"]
pub type R = crate::R<u32, super::RAM1_CTL0>;
#[doc = "Writer for register RAM1_CTL0"]
pub type W = crate::W<u32, super::RAM1_CTL0>;
#[doc = "Register RAM1_CTL0 `reset()`'s with value 0x01"]
impl crate::ResetValue for super::RAM1_CTL0 {
    type Type = u32;
    #[inline(always)]
