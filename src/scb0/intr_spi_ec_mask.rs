#[doc = "Reader of register INTR_SPI_EC_MASK"]
pub type R = crate::R<u32, super::INTR_SPI_EC_MASK>;
#[doc = "Writer for register INTR_SPI_EC_MASK"]
pub type W = crate::W<u32, super::INTR_SPI_EC_MASK>;
#[doc = "Register INTR_SPI_EC_MASK `reset()`'s with value 0"]
impl crate::ResetValue for super::INTR_SPI_EC_MASK {
    type Type = u32;
    #[inline(always)]
