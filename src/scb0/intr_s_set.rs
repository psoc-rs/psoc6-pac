#[doc = "Reader of register INTR_S_SET"]
pub type R = crate::R<u32, super::INTR_S_SET>;
#[doc = "Writer for register INTR_S_SET"]
pub type W = crate::W<u32, super::INTR_S_SET>;
#[doc = "Register INTR_S_SET `reset()`'s with value 0"]
impl crate::ResetValue for super::INTR_S_SET {
    type Type = u32;
    #[inline(always)]
